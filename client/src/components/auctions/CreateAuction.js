...
const CreateAuction = ({ showAlert }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (productId) {
          const res = await axios.get(`https://bidbridge-auction-webapp.onrender.com/api/products/${productId}`);
          setProduct(res.data);
        ...
        const userProductsRes = await axios.get('https://bidbridge-auction-webapp.onrender.com/api/products/user/me');
  ...
  const handleProductChange = async (e) => {
    ...
    try {
      ...
      if (selectedProduct) {
        ...
        const res = await axios.get(`https://bidbridge-auction-webapp.onrender.com/api/products/${newProductId}`);
        setProduct(res.data);
        setFormData(prevState => ({
          ...prevState,
          startingBid: res.data.startingPrice
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      const res = await axios.post('https://bidbridge-auction-webapp.onrender.com/api/auctions', auctionData, config);
