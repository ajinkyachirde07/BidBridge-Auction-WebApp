...
const Dashboard = ({ showAlert }) => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const productsRes = await axios.get('http://https://bidbridge-auction-webapp.onrender.com/api/products/user/me');
        setMyProducts(productsRes.data);
        
        // Fetch user's auctions
        const auctionsRes = await axios.get('http://https://bidbridge-auction-webapp.onrender.com/api/auctions/user/me');
        setMyAuctions(auctionsRes.data);
        
        // Fetch user's bids
        const bidsRes = await axios.get('http://https://bidbridge-auction-webapp.onrender.com/api/bids/user/me');
        setMyBids(bidsRes.data);
        
        // Fetch user's won auctions
        const wonRes = await axios.get('http://https://bidbridge-auction-webapp.onrender.com/api/bids/won');
  ...
  const handleDeleteProduct = async (id) => {
    if (window.confirm('Are you sure you want to delete this product?')) {
      try {
        await axios.delete(`http://https://bidbridge-auction-webapp.onrender.com/api/products/${id}`);
  ...
  const handleCancelAuction = async (id) => {
    if (window.confirm('Are you sure you want to cancel this auction?')) {
      try {
        await axios.delete(`http://https://bidbridge-auction-webapp.onrender.com/api/auctions/${id}`);
